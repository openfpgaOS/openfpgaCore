 ...
 *
 * Available BRAM: ~183KB (0x2000-0x2FE00). OS uses 0x0000-0x1FFF.
...
#define OF_APP_BRAM_END    0x0002FE00
#define OF_APP_BRAM_SIZE   (OF_APP_BRAM_END - OF_APP_BRAM_BASE)  /* ~183KB */
