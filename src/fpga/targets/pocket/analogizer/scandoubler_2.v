...
module scandoubler_2 #(parameter LENGTH, parameter HALF_DEPTH, parameter ENABLE_HQ2X = 1)
(
	// system interface
	input             clk_vid,
	input             hq2x,
...
generate if (ENABLE_HQ2X) begin : gen_hq2x
...
end else begin : gen_no_hq2x
	// Bypass: pass through input directly at ce_x4 rate
