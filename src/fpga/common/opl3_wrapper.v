//
// OPL3 hardware wrapper for openfpgaOS
// - Wraps Greg Taylor's opl3_fpga (YMF262, bit-true reverse-engineered)
// - CPU MMIO interface: bank 0 (addr/data) + bank 1 (addr2/data2)
// - Full OPL3 mode: 18 two-operator channels across both register banks
