//
// AXI4 Slave for CRAM0 (single-word async only at this stage).
//
// Currently single-word async to match the legacy axi_psram_slave behaviour
// with PSRAM_BURST_ENABLE undefined.  Sync burst reads will be added in a
// follow-up commit so the slave then matches PocketQuake's working CRAM0
